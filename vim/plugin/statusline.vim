...
set statusline+=%{bbentley#statusline#linter()}
...
set statusline+=%{bbentley#statusline#fileprefix()}
...
set statusline+=%{bbentley#statusline#filetypesymbol()}

" Align all items to right from this point on.
set statusline+=%=

" [5] Show an icon for common options if they are enabled.
set statusline+=%{bbentley#statusline#markdownpreview()}
set statusline+=%{bbentley#statusline#hlsearch()}
set statusline+=%{bbentley#statusline#spell()}
...
" [7] Git HEAD status.
set statusline+=%{bbentley#statusline#git()}
set statusline+=%{repeat('\ ',2)}
