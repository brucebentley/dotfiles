...
"
" nnoremap <buffer><silent> gf :call bbentley#ftplugin#javascript#gotofile(expand('<cfile>'))<Enter>
" nnoremap <buffer><silent> <C-w>f :call bbentley#ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<Enter>
" nnoremap <buffer><silent> <C-w><C-f> :call bbentley#ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<Enter>
" nnoremap <buffer><silent> <C-w>gf :call bbentley#ftplugin#javascript#gotofile(expand('<cfile>'), 'tab split')<Enter>
"
...
""
function! bbentley#ftplugin#javascript#gotofile(fname, ...) abort
    if empty(a:fname)
        return v:false
    endif
