...
"
" See bbentley#statusline#markdownpreview() function for its indicator.
"
" nnoremap <buffer><silent> <LocalLeader>r :call bbentley#ftplugin#markdown#preview()<Enter>
""
function! bbentley#ftplugin#markdown#preview() abort
    if !has('nvim')
        return v:false
    endif
