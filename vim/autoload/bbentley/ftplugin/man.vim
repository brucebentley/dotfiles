...
"
" nnoremap <buffer><silent> gO :call bbentley#ftplugin#man#showtoc()<Enter>
""
function! bbentley#ftplugin#man#showtoc() abort
    if !has('nvim')
        return v:false
    endif
...
"
" nnoremap <buffer><silent> <C-]> :call bbentley#ftplugin#man#jumptag()<Enter>
""
function! bbentley#ftplugin#man#jumptag() abort
    if !has('nvim')
        return v:false
    endif
...
"
" nnoremap <buffer><silent> [g :call bbentley#ftplugin#man#poptag()<Enter>
""
function! bbentley#ftplugin#man#poptag() abort
    if !has('nvim')
        return v:false
    endif
