...
macos_apps_list=(
    ...
    #682658836      # [ Free ]    GarageBand         - A Recording Studio On Your Mac               ( 10.4.3 )
...
macos_homekit_apps_list=(
    ...
    1198176727      # [ $8.99 ]  Controller for HomeKit   - Manage Smart Homes With Ease           ( 5.3.2 )
    #1236886427      # [ FREE  ]  Eve for HomeKit          - For Philips Hue & LIFX                 ( 3.0.0 )
    ...
    #1547121417      # [ $9.99 ]  HomeControl Menu         - Menu Bar App For HomeKit               ( 1.12.5 )
    #1536545668      # [ FREE  ]  HomeHelper               - Connect Video Surveillance To HomeKit  ( 1.0.2 )
    1330266650      # [ $2.99 ]  HomePass                 - Code Storage & Backup                  ( 1.9.8 )
    1533590432      # [ FREE  ]  Homie—Menu Bar App       - Quick Control For HomeKit              ( 1.0.12 )
